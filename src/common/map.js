...
import FeatureInfo from "../app/components/map/FeatureInfo";
  ...
  window.google.maps.event.addListener(
    ...
    (e) => {
      if (Map.regionDrawnHandler) {
        Map.regionDrawnHandler(
          e.overlay,
          toCoordinates(extractCoordinates(e.overlay, e.type))
        );
      }
    }
  );
