          ...
          <Grid container justify="center" spacing={0}>
            <Grid item xs={10} md={6} className="vcenter flow-column" style={styles.wrapper}>
              <List style={styles.horizontalList}>
                <ListItem onClick={() => { handleLanguageChange(0, 'pt-BR') }} style={styles.listItem}>
                  <Button>
                    <img src={pt} alt='' style={{ margin: '0 10px 0 0', maxHeight: '25px' }} />
                    Português
                  </Button>
                </ListItem>
                <ListItem onClick={() => { handleLanguageChange(1, 'en-US') }} style={styles.listItem}>
                  <Button>
                    <img src={en} alt='' style={{ margin: '0 10px 0 0', maxHeight: '25px' }} />
                    English
                  </Button>
                </ListItem>
              </List>
...
}), { login, changeLanguage: LangActions.setLang })(Themed);
