...
import { Container, Tooltip, Box,  Grid, Typography, Link} from '@material-ui/core'
            ...
            <Grid item xs={12} md={9}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={5}>
                  ...
                  <WhiteTextTypography variant="overline"><Link target="_blank" rel="noopener" color="inherit" href="">{t('home.footer.resources.faq')}</Link></WhiteTextTypography>
