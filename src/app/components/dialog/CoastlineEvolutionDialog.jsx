...
const CoastlineEvolutionDialog = ({ open, close }) => {
  const transects = useSelector((state) =>
    state.results.coastlineData ? state.results.coastlineData.transectData : []
  );
  ...
  const shorelineData = useSelector((state) =>
    state.results.coastlineData ? state.results.coastlineData.shorelineData : []
  );
                ...
                onClick={() => {
                  Export.table.toDevice.asShapefileGroup(
                    [
                      ...
                      {
                        features: shorelineData.map((shoreline) => ({
                          ...shoreline,
